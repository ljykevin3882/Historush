...
public class Boss_Kim : MonoBehaviour
{
    ...
    {
        GameObject bulletR = Instantiate(bomb, transform.position, transform.rotation);
        bulletR.transform.position = transform.position + Vector3.right * 2f;
        GameObject bulletRR = Instantiate(bomb, transform.position, transform.rotation);
        bulletRR.transform.position = transform.position + Vector3.right * 5f;
        GameObject bulletL = Instantiate(bomb, transform.position, transform.rotation);
        bulletL.transform.position = transform.position + Vector3.left * 2f;
        GameObject bulletLL = Instantiate(bomb, transform.position, transform.rotation);
        bulletLL.transform.position = transform.position + Vector3.left * 5f;
    ...
    private void PhaseTwo() // 4발 플레이어에게 산탄으로 발사
    {
        ...
        for (int index = 0; index < 4; index++)
        {
            ...
            Vector2 ranVec = new Vector2(Random.Range(-20f, 20f), Random.Range(0f, 2f));
            dirVec += ranVec;
