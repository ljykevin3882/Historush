...
public class Boss_Itohiro : MonoBehaviour
{
    ...
    {
        GameObject bulletR = Instantiate(hiragana[3], transform.position, transform.rotation);
        bulletR.transform.position = transform.position + Vector3.right * 1.5f;
        GameObject bulletRR = Instantiate(hiragana[2], transform.position, transform.rotation);
        bulletRR.transform.position = transform.position + Vector3.right * 3.5f;
        GameObject bulletL = Instantiate(hiragana[1], transform.position, transform.rotation);
        bulletL.transform.position = transform.position + Vector3.left * 1.5f;
        GameObject bulletLL = Instantiate(hiragana[0], transform.position, transform.rotation);
    ...
    private void PhaseTwo() // 7발 플레이어에게 산탄으로 발사
    {
        ...
        {
            GameObject bullet = Instantiate(hiragana[index], transform.position, transform.rotation);
    ...
    private void PhaseThree() // 한발씩 시계방향으로 발사
    {
        ...
        GameObject bullet = Instantiate(hiragana[BulletIdx], transform.position, transform.rotation);
    ...
    private void PhaseFour() // 원형으로 발사
    {
        ...
        {
            GameObject bullet = Instantiate(hiragana[13], transform.position, transform.rotation);
            bullet.transform.position = transform.position;
    ...
    private void Wrong() { // 오답일 시 공격
        ...
        {
            GameObject bullet = Instantiate(hiragana[10], transform.position, transform.rotation);
            bullet.transform.position = transform.position;
