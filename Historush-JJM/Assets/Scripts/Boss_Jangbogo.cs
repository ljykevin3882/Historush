...
public class Boss_Jangbogo : MonoBehaviour
{
    ...
    {
        GameObject bulletR = Instantiate(water_drop, transform.position, transform.rotation);
        bulletR.transform.position = transform.position + Vector3.right * 1.5f;
        GameObject bulletRR = Instantiate(water_drop, transform.position, transform.rotation);
        bulletRR.transform.position = transform.position + Vector3.right * 3.5f;
        GameObject bulletL = Instantiate(water_drop, transform.position, transform.rotation);
        bulletL.transform.position = transform.position + Vector3.left * 1.5f;
        GameObject bulletLL = Instantiate(water_drop, transform.position, transform.rotation);
        ...
        rigidR.AddForce(Vector2.down * 14, ForceMode2D.Impulse);
        rigidRR.AddForce(Vector2.down * 14, ForceMode2D.Impulse);
        rigidL.AddForce(Vector2.down * 14, ForceMode2D.Impulse);
        rigidLL.AddForce(Vector2.down * 14, ForceMode2D.Impulse);
    ...
    private void PhaseTwo() // 7발 플레이어에게 산탄으로 발사
    {
        ...
        {
            GameObject bullet = Instantiate(water_drop, transform.position, transform.rotation);
